...
namespace
{
    ...
    private:
        ...
        void Refresh()
        {
            ...
            std::array<RE::GFxValue, 15> arguments;
            ...
            arguments[14].SetNumber(
                static_cast<double>(expectedRows));

            SKSE::log::info(
                "[MenuDiagnostic] Invoking SetData once: selectedIndex={}, selectedRow={}, firstVisibleIndex={}, expectedRows={}, totalEntries={}",
                selectedIndex_,
                selectedRow,
                firstVisibleIndex_,
                expectedRows,
            ...
            if (renderedRows != static_cast<double>(expectedRows)) {
                SKSE::log::error(
